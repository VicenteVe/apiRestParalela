...
exports.votar = exports.getResultsById = exports.getResults = exports.getCourses = void 0;
...
var votar = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var _req$body, sectionToken, attendance, choice, user, ramos, id_voto, timestamp, votoIngresado;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _req$body = req.body, sectionToken = _req$body.sectionToken, attendance = _req$body.attendance, choice = _req$body.choice;
        ...
        case 3:
          _context.next = 5;
          return _database["default"].query('SELECT id_usuario FROM usuario LIMIT 1');
        case 5:
          user = _context.sent;
          _context.next = 8;
...
var getCourses = /*#__PURE__*/function () {
  ...
  return function getCourses(_x3, _x4) {
    return _ref2.apply(this, arguments);
  };
}();
exports.getCourses = getCourses;
var getResults = function getResults(req, res) {
  res.json('Ver votacion de todas las secciones');
};
exports.getResults = getResults;
var getResultsById = function getResultsById(req, res) {
