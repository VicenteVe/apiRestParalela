  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res, next) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          words = auth.split(" "); // Verifico que sea de tipo Bearer
          if (!(words[0] != "Bearer")) {
            _context.next = 6;
            break;
          }
        ...
        case 6:
          _context.next = 8;
          return fetch("https://api.sebastian.cl/UtemAuth/v1/tokens/validate", {
            headers: {
            ...
            body: JSON.stringify({
              jwt: words[1],
              created: _moment["default"].utc().format()
            })
          }).then(function (res) {
            return res.json();
          });
        case 8:
          auth_res = _context.sent;
          if (auth_res.ok) {
            _context.next = 11;
            break;
          }
        ...
        case 11:
          ...
          req.user_data = (0, _jwtDecode["default"])(words[1]);
